...
```{r boxplot_y, echo = FALSE, message=FALSE, warning=F,fig.width=3, fig.height=2, fig.align='center'}

# Création de l'histogramme pour la variable Cement
p1 <- ggplot(bdd, aes(x = cement)) +
  geom_histogram(bins = 30, fill = "blue", color = "darkgreen") +
  labs(x = "Cement", y = "Fréquence") +
  theme_minimal()
...
```{r , echo = FALSE, message=FALSE, warning=F,fig.width=3, fig.height=2, fig.align='center'}
# 2 Histogramme pour Blast Furnace Slag
...
```{r , echo = FALSE, message=FALSE, warning=F,fig.width=3, fig.height=2, fig.align='center'}
#5 Histogramme pour Superplasticizer
...
```{r , echo = FALSE, message=FALSE, warning=F,fig.width=3, fig.height=2, fig.align='center'}
# 6 Histogramme pour Coarse Aggregate
...
```{r , echo = FALSE, message=FALSE, warning=F,fig.width=3, fig.height=2, fig.align='center'}
# 7 Histogramme pour Fine Aggregate
...
## Une relation floue entre les granulats fins et résistance à la compression.
...
### Histogramme pour la variable `Cement`
...
### Histogramme pour la variable `Blast Furnace Slag`
...
### Histogramme pour la variable `Fly Ash`
...
### Histogramme pour la variable `Water`
...
### Histogramme pour la variable `Superplasticizer`
...
### Histogramme pour la variable `Coarse Aggregate`
...
### Histogramme pour la variable `Fine Aggregate`
...
### Histogramme pour la variable `Concrete Compressive Strength`
