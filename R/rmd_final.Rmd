...
Nous présentons ici les résultats obtenus avec le modèle final, construit à partir des critères AIC/BIC, des résultats de l'analyse descriptives (notamment l'ACP) et des apports de la littérature.
...
En résumé, le modèle final contient six variables principales (age, cement, water, super_plast, blast_furnace, fly_ash) et cinq interactions significatives. Tous les effets inclus sont cohérents avec la littérature et les résultats de l’analyse exploratoire.

Sur le plan de la performance, la validation croisée à 10 groupes donne une erreur moyenne de 109.48 pour le modèle basé uniquement sur les critères AIC, BIC et Fisher. Avec le modèle final, qui inclut des interactions et un effet quadratique, cette erreur descend à 64.56.
