...
On va appliquer ici les méthode pour estimer l'erreur théorique d'un modèle : on regarde de modele complet et le modèle optimale selon BIC à chaque fois
